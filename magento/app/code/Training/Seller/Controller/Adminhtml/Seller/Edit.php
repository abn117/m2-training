...
class Edit extends \Training\Seller\Controller\Adminhtml\Seller
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('training_seller_seller', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Seller %1', $model->getId()) : __('New Seller'));
        return $resultPage;
    }
}
